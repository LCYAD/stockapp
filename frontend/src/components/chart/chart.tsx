...
var { BarSeries, CandlestickSeries, LineSeries, MACDSeries } 
...
var { EquidistantChannel, TrendLine, FibonacciRetracement, DrawingObjectSelector } 
	= require('react-stockcharts/lib/interactive');
...
class CandlestickChart extends React.Component {
	...
	render() {
		...
		return (
			<div>
				<div>
					<button className='btn btn-default' onClick={this.channel} onMouseOver={() => this.svgHoverOn('channel')} onMouseOut={() => this.svgHoverOut('channel')} onLoad={() => this.svgHoverOut('channel')}>
					...
					<button className='btn btn-default' onClick={this.trend} onMouseOver={() => this.svgHoverOn('trend')} onMouseOut={() => this.svgHoverOut('trend')} onLoad={() => this.svgHoverOut('trend')}>
					...
					<button className='btn btn-default' onClick={this.fib} onMouseOver={() => this.svgHoverOn('fib')} onMouseOut={() => this.svgHoverOut('fib')} onLoad={() => this.svgHoverOut('fib')}>
